...
file2 = 'relation_composition.json'
with open(file2, 'r', encoding='utf-8') as file:
    data2 = json.load(file)

file3 = 'relation_disjointness.json'
with open(file3, 'r', encoding='utf-8') as file:
    data3 = json.load(file)

file4 = 'relation_Equiralence.json'
with open(file4, 'r', encoding='utf-8') as file:
    data4 = json.load(file)


for i in range(len(data1)):
    data1[i]["equiralence"] = data4[i]["equir"]
    data1[i]["disjointness"] = data3[i]["equir"]
    data1[i]["composition"] = data2[i]["composition"]

write_to_file(data1, "relation.json")